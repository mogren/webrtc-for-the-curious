...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.7a5e40a8e18eb0e205a51513564360e913843f4d2fb860cb63846b4a1fdaf850.js',function(){input.required=false;search();});}
